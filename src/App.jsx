  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
      ...
      <div style={{ background: "linear-gradient(135deg,#1a1408,#201a0b)", border: "1px solid " + C.gold + "40", borderRadius: 14, padding: 16, textAlign: "center" }}>
        ...
        <div style={{ color: C.gold, fontWeight: 800, fontSize: 15, fontFamily: "'Cormorant Garamond',serif" }}>Bali Founding Retreat</div>
        <div style={{ color: C.muted, fontSize: 12, marginTop: 4 }}>Early August · Founding Members Only · Complete your 40 days ✨</div>
      </div>
    </div>
  );
}
...
function Admin() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={{ background: C.card, border: "1px solid " + C.border, borderRadius: 14, padding: 16 }}>
        <div style={{ color: C.text, fontWeight: 700, marginBottom: 10 }}>📨 Message All Members</div>
        <textarea placeholder="Motivation, protocol reminders, updates..." style={{ width: "100%", minHeight: 80, background: C.surface, border: "1px solid " + C.border, borderRadius: 10, padding: 12, color: C.text, fontSize: 14, resize: "none", outline: "none", fontFamily: "inherit", boxSizing: "border-box", marginBottom: 10 }} />
        <button style={{ padding: "10px 20px", borderRadius: 10, background: "linear-gradient(135deg," + C.accentD + "," + C.accent + ")", border: "none", color: C.bg, fontWeight: 800, cursor: "pointer", fontSize: 14 }}>Send to All ✨</button>
      </div>
    </div>
  );
}
